                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-sm-6 col-md-auto text-center text-sm-start">
                        <div class="footer1-logo bg-white">
                            <a href="index.php"><img width="150" height="150" src="assets/img/home/klogo.jpg" alt="Logo"></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6 col-lg-auto col-xl-auto">
                        <div class="widget footer-widget widget_nav_menu">
                            ...
                            <div class="menu-all-pages-container">
                                <ul class="menu">
                                    <li><a href="#services">Safe, family-style living</a></li>
                                    <li><a href="#services">Individualized care plans</a></li>
                                    <li><a href="#services">Educational & life-skills support</a></li>
                                    <li><a href="#services">Counselling and emotional support</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
